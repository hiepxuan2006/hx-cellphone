...
module.exports.createSlider = (req, res) => {
    const { body, file } = req;
    SliderAction.createSlider(body, file)
...
module.exports.deleteSlider = (req, res) => {
    const { id } = req.params;
    SliderAction.deleteSlider(id).then(sendSuccess(req, res)).catch(sendError(req, res));
};
...
module.exports.getSliderById = (req, res) => {
    const { id } = req.params;
    SliderAction.getSliderById(id).then(sendSuccess(req, res)).catch(sendError(req, res));
};
